...
$conn = new mysqli('localhost', 'root', '','incidencias');
 if ($conn->connect_error) {
    ...
    $sql = "SELECT * FROM `incidencia` join`estado` ON `incidencia`.`estado_id`=`estado`.`id` where `asignado_usuario_id` ='$user' and `incidencia`.`estado_id`=2";
			...
			$conn = new mysqli('localhost', 'root', '','incidencias');
         	...
         	if (isset($_POST['search_id'])) {
                if (!empty($_POST['search_id_number'])) {
                    ...
                    $conn = new mysqli('localhost', 'root', '','incidencias');
                    $sql_1 = "SELECT * FROM `incidencia` WHERE `incidencia`.`id`='$id' and `incidencia`.`estado_id`=2 ";
