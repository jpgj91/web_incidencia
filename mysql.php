...
-- -----------------------------------------------------
-- Table `incidencias`.`error`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `incidencias`.`error` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `incidencias`.`incidencia` (
  ...
  INDEX `fk_incidencia_error1_idx` (`error_id` ASC),
  ...
  CONSTRAINT `fk_incidencia_usuario2`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_incidencia_error1`
    FOREIGN KEY (`error_id`)
    REFERENCES `incidencias`.`error` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `incidencias`.`rol_has_visibilidad`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `incidencias`.`rol_has_visibilidad` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `rol_id` INT NOT NULL,
  `visibilidad_id` INT NOT NULL,
  INDEX `fk_rol_has_visibilidad_visibilidad1_idx` (`visibilidad_id` ASC),
  INDEX `fk_rol_has_visibilidad_rol1_idx` (`rol_id` ASC),
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_rol_has_visibilidad_rol1`
    FOREIGN KEY (`rol_id`)
    REFERENCES `incidencias`.`rol` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_rol_has_visibilidad_visibilidad1`
    FOREIGN KEY (`visibilidad_id`)
    REFERENCES `incidencias`.`visibilidad` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- Table `error`
-- -----------------------------------------------------
INSERT INTO `error`(`name`) VALUES ("error");
INSERT INTO `error`(`name`) VALUES ("otro");
-- -----------------------------------------------------
-- Table `visibilidad`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
INSERT INTO `rol_has_visibilidad`(`rol_id`, `visibilidad_id`) VALUES ("1","1");
INSERT INTO `rol_has_visibilidad`(`rol_id`, `visibilidad_id`) VALUES ("2","1");
INSERT INTO `rol_has_visibilidad`(`rol_id`, `visibilidad_id`) VALUES ("2","2");
INSERT INTO `rol_has_visibilidad`(`rol_id`, `visibilidad_id`) VALUES ("3","2");